...
<body>
	...
	<div id="wrapper">
		...
		<section id="intro" class="wrapper style1 fullscreen fade-up">
			<div class="inner">
				<h1>라면 API</h1>
				<p>라면은 굉장히 맛있습니다. 그러므로 라면에 대한 API가 절실하게 필요했고, 라면에 관한 API가 존재하지
					않는다는 것을 깨닳았을 때 이 API의 탄생을 직감하였습니다. 그리고 그 탄생을 저희가 이뤄낸 과업입니다. 라면의,
					라면을 위한, 라면에 의한 API는 라면에 관한 모든 데이터를 무료로 사용하실 수 있습니다! 사실 뻘소리를 쓴 것이니
					자세히 들여다보시지 말아주세요.</p>
				<ul class="actions">
					<li><a href="#three" class="button scrolly">Using data in
							web</a></li>
				</ul>
			</div>
		</section>
			...
			<div class="inner">
				...
				<div class="features">
					<section>
						...
						<p>brand, name, type, noodleType, soupColor, weight,
							releaseDate</p>
					</section>
					<section>
						...
						<p>colories, carbonhydrate, protein, fat, staturedFat,
							transFat, cholesterol, natrium</p>
					</section>
					<section>
			...
			<section>
				<div class="content">
					<div class="inner">
						<h2>Preparations</h2>
						<ul>
							<p>애플리케이션 등록: Ramen open API로 개발하시려면 먼저 'Mypage-developer'
								메뉴에서 API 사용 등록을 하셔야 합니다.</p>
							<li>Client ID 확인: 'developer'에서 사용 등록한 Client를 선택하면 Client
								ID 값을 확인할 수 있습니다.</li>
							<li>Client PW 확인: 'developer'에서 사용 등록한 Client를 선택하면 Client
								PW 값을 확인할 수 있습니다.</li>
						</ul>
						<ul class="actions">
						</ul>
			...
			<section>
				<div class="content">
					<div class="inner">
						...
						<ul class="actions">
							<li><a
								href="https://github.com/bitpotentialteam/noodleAPI/tree/master/src/main/java/org/noodle/example"
								target="_blank" class="button">Learn more</a></li>
						</ul>
					</div>
				</div>
				<a href="#" class="image"><img src="../images/pic05.jpg" alt=""
					data-position="top center" /></a>
			</section>
		</section>
		...
		<section id="three" class="wrapper style1 fade-up">
			<div class="inner">
				...
				<div class='groupType'>
					...
					<div class="noodleTypeCheckbox">
						<span id='dry'><input type="checkbox"
							name=noodleTypeCheckbox><label>건면</label></span> <span id='raw'><input
							type="checkbox" name=noodleTypeCheckbox><label>생면</label></span>
						<span id='oil'><input type="checkbox"
							name=noodleTypeCheckbox><label>유탕면</label></span>
					</div>
				</div>
				<div class='groupType'>
					<p>data type</p>
				...
				<section>
					<ul class="contact">
						<li>
							<h3>Address</h3> <span>비트캠프 | 서울시 서초구 서초동 1327-15번지 비트아카데미
								빌딩 3층 <br /> 사업자등록번호: 214-85-24928 | (주)비트컴퓨터 서초지점 대표 조현정<br />
						</span>
						</li>
						<li>
							<h3>Email</h3> <a href="#"> bit@bitacademy.net</a>
						</li>
						<li>
							<h3>Phone</h3> <span>02)3486-9600</span>
						</li>
					</ul>
				</section>
			</div>
				...
				$(document).ready(function() {
					...
					$(".noodleTypeCheckbox span").on("click", function() {
						...
						if (input.is(":checked")) {
							...
							$.ajax({
								url : '../noodleTypeFilter/' + noodleTypeValue,
								type : 'POST',
